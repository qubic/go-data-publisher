module github.com/qubic/computors-publisher
...
require (
	...
	github.com/qubic/go-archiver-v2 v1.1.0
...
require (
	...
	github.com/cloudflare/fourq v0.0.0-20241014204117-d1fc726fa289 // indirect
