...
func (UnimplementedStatusServiceServer) GetTickIntervals(context.Context, *emptypb.Empty) (*GetTickIntervalsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetTickIntervals not implemented")
}
func (UnimplementedStatusServiceServer) GetArchiverStatus(context.Context, *emptypb.Empty) (*GetArchiverStatusResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetArchiverStatus not implemented")
}
func (UnimplementedStatusServiceServer) GetErroneousSkippedTicks(context.Context, *emptypb.Empty) (*GetSkippedTicksResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetErroneousSkippedTicks not implemented")
}
