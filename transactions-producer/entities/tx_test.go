...
func TestTx_MarshalAndUnmarshal(t *testing.T) {
	transaction := &Tx{
	...
	expectedJson := `{"transactionHash":"transaction-hash","source":"source-identity","destination":"destination-identity","amount":1,"tickNumber":2,"inputType":3,"inputSize":4,"inputData":"input-data","signature":"signature","timestamp":5,"moneyFlew":true}`
